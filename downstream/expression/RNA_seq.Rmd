...
OUT_FOLDER_DEGs <- "/Users/ieo6983/Desktop/expression/DEGs/"
setwd(IN_FOLDER)
```
...
#write.csv(df_export, file=paste0(OUT_FOLDER_DEGs, "DEGs_Condition_GRHL2KD_SCR.csv"))
...
#df_LFC_sig %>% arrange(., log2FoldChange) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "./Df_DEGs.df_LFC_sig.padj_0.01.log2FC_1.Up_and_Down.tsv"))
...
#ggsave(plot = p$Plot, filename = "./GSEA/Plots/GSEA.DB_h.all.v2023.2.Hs.top_10.png", device = "png", width = 10, height = 6)
```
