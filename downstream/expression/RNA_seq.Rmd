...
#OUT_FOLDER_DEGs <- fs::path("/Users/ieo6983/Desktop/expression/DEGs/")
...
g_1st <- read_tsv(fs::path(IN_FOLDER,"results_1st_group/star_salmon/salmon.merged.gene_counts.tsv"))
g_2nd <- read_tsv(fs::path(IN_FOLDER, "results_2nd_group/star_salmon/salmon.merged.gene_counts.tsv"))
...
#df_LFC_sig %>% arrange(., log2FoldChange) %>% write_tsv(., fs::path(OUT_FOLDER_DEGs, "Df_DEGs.df_LFC_sig.padj_0.01.log2FC_1.Up_and_Down.tsv"))
...
#data.frame(df_LFC_sig[df_LFC_sig$DE == "Up", ]$gene_id) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_LFC_sig.padj_0.05.log2FC_1.UP.tsv"), col_names = F)
#data.frame(df_LFC_sig[df_LFC_sig$DE == "Up", ]$gene_name) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_LFC_sig.padj_0.05.log2FC_1.UP.names.tsv"), col_names = F)

#data.frame(df_LFC_sig[df_LFC_sig$DE == "Down", ]$gene_id) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_LFC_sig.padj_0.05.log2FC_1.DOWN.tsv"), col_names = F)
#data.frame(df_LFC_sig[df_LFC_sig$DE == "Down", ]$gene_name) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_LFC_sig.padj_0.05.log2FC_1.DOWN.names.tsv"), col_names = F)


# Not shrinked
#data.frame(df_export_sig[df_export_sig$DE == "Up", ]$gene_id) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_export_sig.padj_0.05.log2FC_1.UP.tsv"), col_names = F)
#data.frame(df_export_sig[df_export_sig$DE == "Up", ]$gene_name) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_export_sig.padj_0.05.log2FC_1.UP.names.tsv"), col_names = F)

#data.frame(df_export_sig[df_export_sig$DE == "Down", ]$gene_id) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_export_sig.padj_0.05.log2FC_1.Down.tsv"), col_names = F)
#data.frame(df_export_sig[df_export_sig$DE == "Down", ]$gene_name) %>% write_tsv(., paste0(OUT_FOLDER_DEGs, "DEGs.df_export_sig.padj_0.05.log2FC_1.Down.names.tsv"), col_names = F)
