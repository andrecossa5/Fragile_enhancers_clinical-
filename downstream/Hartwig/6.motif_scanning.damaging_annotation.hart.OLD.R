...
path_enh_SSMs <- list("CtIP" = fs::path(paste0("/hpcnfs/scratch/P_PGP_FRAGILE_ENHANCERS/results/data/CtIP_enh.hartwig_snvs.overlap.WIN_3000.tsv")), 
                      "GRHL" = fs::path(paste0("/hpcnfs/scratch/P_PGP_FRAGILE_ENHANCERS/results/data/GRHL_enh.hartwig_snvs.overlap.WIN_3000.tsv")))
